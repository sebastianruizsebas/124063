...
#define t _nt->_t
#define dt _nt->_dt
#define glbar _ml->template fpfield<0>(_iml)
#define glbar_columnindex 0
#define el _ml->template fpfield<1>(_iml)
...
static void nrn_alloc(Prop* _prop) {
  ...
  Datum *_ppvar{};
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 6);
 	...
 	glbar = _parm_default[0]; /* 0.52 */
 	el = _parm_default[1]; /* -74 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 6);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"glbar"} /* 0 */,
                                       _nrn_mechanism_field<double>{"el"} /* 1 */,
  ...
  hoc_register_prop_size(_mechtype, 6, 0);
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Leak /home/srsebwsl/Project2_Retina/Files/Rod_leak.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/srsebwsl/Project2_Retina/Files/Rod_leak.mod";
