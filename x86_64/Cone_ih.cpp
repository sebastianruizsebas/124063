...
#define gh _ml->template fpfield<3>(_iml)
#define gh_columnindex 3
#define nh _ml->template fpfield<4>(_iml)
#define nh_columnindex 4
#define Dnh _ml->template fpfield<5>(_iml)
#define Dnh_columnindex 5
#define infh _ml->template fpfield<6>(_iml)
#define infh_columnindex 6
#define tauh _ml->template fpfield<7>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 1, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	...
 	ghbar = _parm_default[0]; /* 3.5 */
 	eh = _parm_default[1]; /* -32.5 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"gh"} /* 3 */,
                                       _nrn_mechanism_field<double>{"nh"} /* 4 */,
                                       _nrn_mechanism_field<double>{"Dnh"} /* 5 */,
                                       _nrn_mechanism_field<double>{"infh"} /* 6 */,
                                       _nrn_mechanism_field<double>{"tauh"} /* 7 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 h_cone /home/srsebwsl/Project2_Retina/Files/Cone_ih.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/srsebwsl/Project2_Retina/Files/Cone_ih.mod";
