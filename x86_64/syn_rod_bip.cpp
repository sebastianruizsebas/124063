...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _syn_rod_bip_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GradSyn /home/srsebwsl/Project2_Retina/Files/syn_rod_bip.mod\n");
...
/*CVODE*/
 static int _ode_spec1 () {_reset=0;
 {
   ...
   if ( V_pre < V_thr ) {
     s_inf = tanh ( ( V_thr - V_pre ) / V_slope ) ;
     }
   if ( s < 1e-06 ) {
     s = 1e-06 ;
     }
 ...
 v=_v;
{
 ...
 if(error){
  std_cerr_stream << "at line 30 in file syn_rod_bip.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/srsebwsl/Project2_Retina/Files/syn_rod_bip.mod";
