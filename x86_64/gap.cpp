...
#define r _ml->template fpfield<0>(_iml)
#define r_columnindex 0
#define i _ml->template fpfield<1>(_iml)
#define i_columnindex 1
#define _g _ml->template fpfield<2>(_iml)
#define _g_columnindex 2
#define _nd_area *_ml->dptr_field<0>(_iml)
#define vgap	*_ppvar[2].get<double*>()
#define _p_vgap _ppvar[2].literal_value<void*>()
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"r"} /* 0 */,
                                       _nrn_mechanism_field<double>{"i"} /* 1 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 2 */,
                                       _nrn_mechanism_field<double*>{"_nd_area", "area"} /* 0 */,
                                       _nrn_mechanism_field<Point_process*>{"_pntproc", "pntproc"} /* 1 */,
                                       _nrn_mechanism_field<double*>{"vgap", "pointer"} /* 2 */);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 gap /home/srsebwsl/Project2_Retina/Files/gap.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/srsebwsl/Project2_Retina/Files/gap.mod";
