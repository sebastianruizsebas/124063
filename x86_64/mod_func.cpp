...
extern "C" void _A2hh_k_reg(void);
extern "C" void _A2hh_na_reg(void);
extern "C" void _Bip_Ca_reg(void);
extern "C" void _Bip_Cad_reg(void);
extern "C" void _Bip_Ka_reg(void);
extern "C" void _Bip_Kv_reg(void);
extern "C" void _Bip_ih_reg(void);
extern "C" void _Cone_CPR_reg(void);
extern "C" void _Cone_Kv_reg(void);
extern "C" void _Cone_ih_reg(void);
extern "C" void _Ganglion_hh_reg(void);
extern "C" void _IinjLT_reg(void);
extern "C" void _IinjLTDim_reg(void);
extern "C" void _IinjLT_cone_reg(void);
extern "C" void _Rod_Ca_reg(void);
extern "C" void _Rod_Cad_reg(void);
extern "C" void _Rod_Clca_reg(void);
extern "C" void _Rod_Kca_reg(void);
extern "C" void _Rod_Kv_reg(void);
extern "C" void _Rod_Kx_reg(void);
extern "C" void _Rod_ih_reg(void);
extern "C" void _Rod_leak_reg(void);
extern "C" void _gap_reg(void);
extern "C" void _syn_bip_gan_reg(void);
extern "C" void _syn_rod_bip_reg(void);
