...
#define nrn_init _nrn_init__IinjLT_cone
#define _nrn_initial _nrn_initial__IinjLT_cone
#define nrn_cur _nrn_cur__IinjLT_cone
#define _nrn_current _nrn_current__IinjLT_cone
#define nrn_jacob _nrn_jacob__IinjLT_cone
#define nrn_state _nrn_state__IinjLT_cone
#define _net_receive _net_receive__IinjLT_cone 
...
#define Part4 _ml->template fpfield<15>(_iml)
#define Part4_columnindex 15
#define ssInA _ml->template fpfield<16>(_iml)
#define ssInA_columnindex 16
#define ampnA _ml->template fpfield<17>(_iml)
#define ampnA_columnindex 17
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 3, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 21);
 	...
 	amp = _parm_default[4]; /* 20 */
 	ssI = _parm_default[5]; /* 20 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 21);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _IinjLT_cone_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"Part4"} /* 15 */,
                                       _nrn_mechanism_field<double>{"ssInA"} /* 16 */,
                                       _nrn_mechanism_field<double>{"ampnA"} /* 17 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 IinjLT_cone /home/srsebwsl/Project2_Retina/Files/IinjLT_cone.mod\n");
...
{ {
   ...
   if ( on  == 1.0 ) {
     Part1 = ( 1.01 ) * pow( ( 1.0 - exp ( - tr / 60.0 ) ) , 3.0 ) ;
     Part2 = - ( 0.07 ) / ( 1.0 + exp ( - ( tr - 555.0 ) / 120.0 ) ) ;
     Part3 = - 0.7 / pow( ( 1.0 + exp ( - ( tr - 1500.0 ) / 200.0 ) ) , 1.3 ) ;
     Part4 = - ( 0.24 ) / pow( ( ( 1.0 + exp ( - ( tr - 1200.0 ) / 80.0 ) ) ) , 2.0 ) ;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/srsebwsl/Project2_Retina/Files/IinjLT_cone.mod";
